...
function numberGroups ({a,b,c}){
  ...
  var longestArray = Math.max(a.length,b.length,c.length) 
  if(a.length === longestArray){return a}
  else if(b.length === longestArray){return b}
  else if(c.length === longestArray){return c}
